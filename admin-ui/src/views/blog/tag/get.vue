<template>
  <a-spin :loading="load">
    <a-form size="large" label-align="left" class="form" layout="vertical" :model="formData">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item field="sourceShow" :label="$t('tag.sourceId')">
            <label class="upIcon" for="upMainImgtag">
        ...
        <a-col :span="24">
          <a-form-item field="summary" :label="$t('tag.summary')">
...
import { tagInit, tagGet } from '@/api/blog/tag'
// 入参读取
