...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,p,o]}]}}})());hljs.registerLanguage("basic",(()=>{"use strict";return E=>({name:"BASIC",
...
contains:[e.UNDERSCORE_TITLE_MODE]},l,s]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("kotlin",(()=>{"use strict"
